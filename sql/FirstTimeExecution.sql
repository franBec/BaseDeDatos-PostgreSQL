...
--
-- Incorporar un nuevo mozo de nombre “Krusty”, con domicilio en “Aristóbulo del Valle 3432” y DNI 25544555
-- asigno arbitrariamente el valor 1999
--
INSERT INTO mozos VALUES (1999, 'Krusty', 'Aristóbulo del Valle 3432', 25544555);

--
--Actualizar el precio de venta del plato “Semillas Senzu” a $690
--
UPDATE platos SET P_PrecioVenta = 690 WHERE P_Nombre = 'Semillas Senzu';

--
--Eliminar al mozo “Jesse Pinkman” de la base de datos
--
DELETE FROM mozos WHERE Mo_NombreApellido = 'Jesse Pinkman';